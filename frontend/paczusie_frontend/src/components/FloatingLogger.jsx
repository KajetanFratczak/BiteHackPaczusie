...
const FloatingLogger = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-[#233D4D] text-[#F5FBE6] p-6 text-center shadow-md flex justify-center items-center gap-4 font-bold text-lg z-50">
